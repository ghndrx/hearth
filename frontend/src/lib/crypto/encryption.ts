...
export async function encryptFile(
  ...
  // Ensure we have a regular ArrayBuffer, not a SharedArrayBuffer
...
function base64ToArrayBuffer(base64: string): ArrayBuffer {
  ...
  // Create a fresh Uint8Array copy to ensure we get a regular ArrayBuffer,
  // not a SharedArrayBuffer (which SubtleCrypto rejects)

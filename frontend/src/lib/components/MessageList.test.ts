...
describe('MessageList', () => {
	...
	describe('rendering', () => {
		...
		it('should render channel name in welcome when channel is selected', async () => {
			mockCurrentChannelStore.set(createMockChannel({ name: 'test-channel' }));
			const MessageList = (await import('./MessageList.svelte')).default;

			render(MessageList);

			// Channel name appears in welcome message
	...
	describe('scroll behavior', () => {
		it('should have scrollable message container', async () => {
			...
			// MessageList uses .message-list-container with overflow-y: auto in CSS
	...
	describe('edge cases', () => {
		it('should handle channel with no topic', async () => {
			...
			// Should render without error - the channel name appears in the welcome message
	...
	describe('message actions', () => {
		...
		it('should render messages with action handlers available', async () => {
			...
			// Message should be rendered (handlers are internal to Message component)

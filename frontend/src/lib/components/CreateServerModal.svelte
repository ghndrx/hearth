...
<Modal {open} title={step === 'choose' ? 'Add a Server' : step === 'create' ? 'Create a Server' : 'Join a Server'} on:close={close}>
	{#if step === 'choose'}
		<div class="options">
	...
	{:else if step === 'create'}
		<form on:submit|preventDefault={handleCreate}>
			...
			<p class="hint">
				By creating a server, you agree to Hearth's Community Guidelines.
			</p>
		</form>
	...
	{:else}
		<form on:submit|preventDefault={handleJoin}>
			...
			<p class="hint">
				Invites look like: https://hearth.chat/AbCdEf or AbCdEf
			</p>
		</form>
	{/if}

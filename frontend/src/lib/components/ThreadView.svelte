	...
	<aside class="thread-panel">
		...
		<header class="thread-header">
			<div class="thread-header-left">
				<svg class="thread-icon" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
			...
			<button class="close-btn" on:click={close} title="Close thread">
		...
		<!-- Thread Messages -->
		<div class="thread-messages" bind:this={messageListEl}>
			{#if $threadLoading}

<script lang="ts">
	...
	import { backdropFade, modalPop } from '$lib/utils/transitions';
...
{#if open}
	...
	<div class="modal-backdrop" transition:backdropFade={{ duration: 150 }} on:click={handleBackdropClick}>
		<div
			class="modal {size}"
			...
			transition:modalPop={{ duration: 200 }}

...
describe('Auth Store', () => {
  ...
  describe('init()', () => {
    ...
    it('should load user when valid token exists', async () => {
      ...
      // Backend user format (what API returns)
      ...
      // Expected normalized user format (what normalizeUser outputs)
      const expectedUser = {
        id: 'user-1',
        username: 'testuser',
        display_name: null,
      ...
      mockApi.get.mockResolvedValueOnce(mockBackendUser);
  ...
  describe('updateProfile()', () => {
    it('should update user profile', async () => {
      // updateProfile returns User directly (no normalization)
      const updatedUser = {
        id: 'user-1',
        username: 'testuser',

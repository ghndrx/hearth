...
func (m *mockThreadRepository) GetByParentMessageID(ctx context.Context, messageID uuid.UUID) (*models.Thread, error) {
	return nil, nil
}
...
func (m *mockChannelRepoForThread) RemoveRecipient(ctx context.Context, channelID, userID uuid.UUID) error {
	return nil
}

func (m *mockChannelRepoForThread) CountRecipients(ctx context.Context, channelID uuid.UUID) (int, error) {
	return 0, nil
}

func (m *mockChannelRepoForThread) BulkUpdatePositions(ctx context.Context, entries []models.ReorderChannelEntry) error {
	return nil
}
...
func (m *mockServerRepoForThread) GetMembersPaginated(ctx context.Context, serverID uuid.UUID, cursor *models.MemberCursor, limit int) (*models.PaginatedMembers, error) {
...
func (m *mockServerRepoForThread) GetInviteByVanityCode(ctx context.Context, vanityCode string) (*models.Invite, error) {
	return nil, nil
}
...
func (m *mockServerRepoForThread) LogInviteUse(ctx context.Context, log *models.InviteUseLog) error {
	return nil
}

func (m *mockServerRepoForThread) GetInviteUseLogs(ctx context.Context, inviteCode string) ([]models.InviteUseLog, error) {
	return nil, nil
}

func (m *mockServerRepoForThread) GetServerInviteUseLogs(ctx context.Context, serverID uuid.UUID) ([]models.InviteUseLog, error) {
	return nil, nil
}

func (m *mockServerRepoForThread) GetMembersWithRole(ctx context.Context, serverID, roleID uuid.UUID) ([]*models.Member, error) {
	return []*models.Member{}, nil
}

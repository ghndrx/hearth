...
// SetRateLimiter sets the rate limiter for component interactions
func (s *ComponentService) SetRateLimiter(rateLimiter ComponentRateLimiter) {
...
func (s *ComponentService) HandleInteraction(
	...
	// Check rate limit for component interactions
	if s.rateLimiter != nil {
		if err := s.rateLimiter.CheckComponentInteraction(ctx, userID); err != nil {

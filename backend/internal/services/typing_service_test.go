...
func TestTypingService_StartTyping(t *testing.T) {
	...
	mockEventBus.On("Publish", events.TypingStarted, mock.AnythingOfType("*models.TypingIndicator")).Return()
	...
	mockEventBus.AssertCalled(t, "Publish", events.TypingStarted, mock.AnythingOfType("*models.TypingIndicator"))
}
...
func TestTypingService_EventBusReceivesIndicator(t *testing.T) {
	...
	mockEventBus.On("Publish", events.TypingStarted, mock.MatchedBy(func(indicator *models.TypingIndicator) bool {

...
// Returns a ParsedSearchQuery which can be converted to SearchMessageOptions
// using ToSearchMessageOptions() after resolving user/channel references
func ParseSearchQuery(query string) *ParsedSearchQuery {
	return ParseSearchQueryString(query)
}

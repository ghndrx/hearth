...
// GetBlockedUsers retrieves the list of users blocked by the given user
func (s *UserService) GetBlockedUsers(ctx context.Context, userID uuid.UUID) ([]*models.User, error) {

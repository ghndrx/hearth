...
func newTestRoleService() (*RoleService, *MockRoleRepository, *MockServerRepository, *MockCacheService, *MockEventBus) {
	...
	service := NewRoleService(roleRepo, serverRepo, cache, eventBus, nil)
...
func TestCreateRole_Success(t *testing.T) {
	...
	server := &models.Server{
		ID:      serverID,
		OwnerID: uuid.New(), // Creator is not owner
	}

	// Mocks for permission check
	serverRepo.On("GetByID", ctx, serverID).Return(server, nil)
	roleRepo.On("GetMemberRoles", ctx, serverID, creatorID).Return([]*models.Role{
		{ID: uuid.New(), ServerID: serverID, Permissions: models.PermManageRoles, Position: 0},
	}, nil)
...
func TestCreateRole_GetRolesError(t *testing.T) {
	...
	server := &models.Server{ID: serverID, OwnerID: creatorID} // Creator is owner (has all perms)
...
func TestCreateRole_CreateError(t *testing.T) {
	...
	member := &models.Member{UserID: creatorID, ServerID: serverID}
	server := &models.Server{ID: serverID, OwnerID: creatorID} // Creator is owner
	dbErr := errors.New("db error")
...
func TestUpdateRole_Success(t *testing.T) {
	...
	existingRole := &models.Role{
		...
		Color:       0xFF0000,
		Permissions: 0,
		Position:    5, // Role at position 5
	}

	server := &models.Server{ID: serverID, OwnerID: requesterID} // Requester is owner
...
func TestUpdateRole_UpdateError(t *testing.T) {
	...
	existingRole := &models.Role{ID: roleID, ServerID: serverID, Position: 5}
	server := &models.Server{ID: serverID, OwnerID: requesterID} // Requester is owner
	member := &models.Member{UserID: requesterID, ServerID: serverID}
	name := "New"
...
func TestDeleteRole_DeleteError(t *testing.T) {
	...
	role := &models.Role{ID: roleID, ServerID: serverID, IsDefault: false, Position: 5}
	server := &models.Server{ID: serverID, OwnerID: requesterID} // Requester is owner
	member := &models.Member{UserID: requesterID, ServerID: serverID}
...
func TestAddRoleToMember_Success(t *testing.T) {
	...
	role := &models.Role{ID: roleID, ServerID: serverID, Position: 5}
...
func TestAddRoleToMember_RoleNotFound(t *testing.T) {
	...
	server := &models.Server{ID: serverID, OwnerID: requesterID}
	requesterMember := &models.Member{UserID: requesterID, ServerID: serverID}
	targetMember := &models.Member{UserID: userID, ServerID: serverID}

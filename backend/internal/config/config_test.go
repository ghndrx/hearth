...
func TestRateLimitConfig_Defaults(t *testing.T) {
	...
	if cfg.RateLimitMax != 10000 {
		t.Errorf("expected default RateLimitMax 10000, got %d", cfg.RateLimitMax)
	}
...
func TestBcryptPoolConfig_Defaults(t *testing.T) {
	...
	if cfg.BcryptPoolWorkers != 0 {
		t.Errorf("expected default BcryptPoolWorkers 0 (auto), got %d", cfg.BcryptPoolWorkers)
	}
	if cfg.BcryptPoolQueue != 0 {
		t.Errorf("expected default BcryptPoolQueue 0 (auto), got %d", cfg.BcryptPoolQueue)
	}
	if cfg.BcryptPoolTimeout != 5*time.Second {
		t.Errorf("expected default BcryptPoolTimeout 5s, got %v", cfg.BcryptPoolTimeout)
	}
}
...
func TestBcryptPoolConfig_CustomValues(t *testing.T) {
	...
	if cfg.BcryptPoolQueue != 100 {
		t.Errorf("expected BcryptPoolQueue 100, got %d", cfg.BcryptPoolQueue)
	}
	if cfg.BcryptPoolTimeout != 10*time.Second {
		t.Errorf("expected BcryptPoolTimeout 10s, got %v", cfg.BcryptPoolTimeout)
	}
}
...
func TestDrainConfig_Defaults(t *testing.T) {
	...
	if cfg.DrainGracePeriod != 5*time.Second {
		t.Errorf("expected default DrainGracePeriod 5s, got %v", cfg.DrainGracePeriod)
	}
}
...
func TestDrainConfig_CustomValues(t *testing.T) {
	...
	if cfg.DrainGracePeriod != 10*time.Second {
		t.Errorf("expected DrainGracePeriod 10s, got %v", cfg.DrainGracePeriod)
	}
}

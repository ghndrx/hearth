...
func setupServerTestApp(t *testing.T, serverSvc *mockServerService, channelSvc *mockChannelService, roleSvc *mockRoleService, userID uuid.UUID) *fiber.App {
	t.Helper()
	app := fiber.New()
...
func TestServerHandler_Create(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			app := setupServerTestApp(t, serverSvc, &mockChannelService{}, &mockRoleService{}, userID)
...
func TestServerHandler_Roles(t *testing.T) {
	...
	t.Run("get roles", func(t *testing.T) {
		...
		app := setupServerTestApp(t, &mockServerService{}, &mockChannelService{}, roleSvc, userID)
...
func TestServerHandler_Channels(t *testing.T) {
	...
	t.Run("get channels", func(t *testing.T) {
		...
		app := setupServerTestApp(t, &mockServerService{}, channelSvc, &mockRoleService{}, userID)
...
func TestServerHandler_GetRoles_InvalidServerID(t *testing.T) {
	...
	app := setupServerTestApp(t, &mockServerService{}, &mockChannelService{}, &mockRoleService{}, userID)

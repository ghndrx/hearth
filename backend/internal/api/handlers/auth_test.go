...
type mockAuthService struct {
	...
	loginWithMFAFunc   func(ctx context.Context, email, password, mfaCode string) (*models.User, *services.AuthTokens, error)
	...
	enableMFAFunc      func(ctx context.Context, userID uuid.UUID) (*services.MFASetupResponse, error)
	verifyMFASetupFunc func(ctx context.Context, userID uuid.UUID, code string) error
	disableMFAFunc     func(ctx context.Context, userID uuid.UUID, password string) error
	verifyMFAFunc      func(ctx context.Context, userID uuid.UUID, code string) error
	checkUserMFAFunc   func(ctx context.Context, email string) (bool, error)
}
...
func (m *mockAuthService) LoginWithMFA(ctx context.Context, email, password, mfaCode string) (*models.User, *services.AuthTokens, error) {
	if m.loginWithMFAFunc != nil {
		return m.loginWithMFAFunc(ctx, email, password, mfaCode)
	}
	return nil, nil, nil
}
...
func (m *mockAuthService) VerifyMFASetup(ctx context.Context, userID uuid.UUID, code string) error {
	if m.verifyMFASetupFunc != nil {
		return m.verifyMFASetupFunc(ctx, userID, code)
	}
	return nil
}
...
func (m *mockAuthService) DisableMFA(ctx context.Context, userID uuid.UUID, password string) error {
	if m.disableMFAFunc != nil {
		return m.disableMFAFunc(ctx, userID, password)
	}
	return nil
}
...
func (m *mockAuthService) VerifyMFA(ctx context.Context, userID uuid.UUID, code string) error {
	if m.verifyMFAFunc != nil {
		return m.verifyMFAFunc(ctx, userID, code)
	}
	return nil
}

func (m *mockAuthService) CheckUserMFA(ctx context.Context, email string) (bool, error) {
	if m.checkUserMFAFunc != nil {
		return m.checkUserMFAFunc(ctx, email)
	}
	return false, nil
}

...
func setupChannelTestApp(t *testing.T, messageService *mockChannelMessageService) *fiber.App {
	t.Helper()
	app := fiber.New()
...
func setupChannelCRUDTestApp(t *testing.T, channelSvc *mockChannelCRUDService) *fiber.App {
	t.Helper()
	app := fiber.New()
	t.Cleanup(func() { app.Shutdown() })
...
func TestChannelHandler_Get_Success(t *testing.T) {
	...
	app := setupChannelCRUDTestApp(t, svc)
...
func setupTypingTestApp(t *testing.T, channelSvc *mockChannelCRUDService, typingSvc *mockTypingService) *fiber.App {
	t.Helper()
	app := fiber.New()
	t.Cleanup(func() { app.Shutdown() })
...
func TestTypingHandler_TriggerTyping_Success(t *testing.T) {
	...
	app := setupTypingTestApp(t, channelSvc, typingSvc)
...
func TestTypingHandler_GetTypingUsers_NilTypingService(t *testing.T) {
	...
	// nil typing service
	app := setupTypingTestApp(t, channelSvc, nil)

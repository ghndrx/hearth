...
// @Description Creates a new poll in a channel with a question and multiple options
// @Tags Polls
// @Accept json
// @Produce json
// @Param id path string true "Channel ID"
// @Param body body CreatePollRequest true "Poll creation request"
// @Success 201 {object} models.Poll "Poll created successfully"
// @Failure 400 {object} fiber.Map "Invalid channel ID or request body"
// @Failure 401 {object} fiber.Map "Unauthorized"
// @Failure 500 {object} fiber.Map "Internal server error"
// @Router /channels/{id}/polls [post]
...
// @Description Returns a poll with its details and options
// @Tags Polls
// @Produce json
// @Param id path string true "Poll ID"
// @Success 200 {object} models.Poll "Poll details"
// @Failure 400 {object} fiber.Map "Invalid poll ID"
// @Failure 404 {object} fiber.Map "Poll not found"
// @Router /polls/{id} [get]
...
// @Description Casts a vote on a specific option in a poll
// @Tags Polls
// @Accept json
// @Produce json
// @Param id path string true "Poll ID"
// @Param body body VoteRequest true "Vote request"
// @Success 200 {object} fiber.Map "Vote recorded successfully"
// @Failure 400 {object} fiber.Map "Invalid poll ID or option ID"
// @Failure 401 {object} fiber.Map "Unauthorized"
// @Failure 403 {object} fiber.Map "Poll is closed"
// @Failure 409 {object} fiber.Map "Already voted on this poll"
// @Failure 500 {object} fiber.Map "Internal server error"
...
// @Description Returns the current results of a poll with vote counts and percentages
// @Tags Polls
// @Produce json
// @Param id path string true "Poll ID"
// @Success 200 {object} fiber.Map "Poll results with vote counts and percentages"
// @Failure 400 {object} fiber.Map "Invalid poll ID"
// @Failure 404 {object} fiber.Map "Poll not found"
...
// @Description Closes a poll so no more votes can be cast. Only the poll creator can close a poll.
// @Tags Polls
// @Accept json
// @Produce json
// @Param id path string true "Poll ID"
// @Success 200 {object} fiber.Map "Poll closed successfully"
// @Failure 400 {object} fiber.Map "Invalid poll ID"
// @Failure 401 {object} fiber.Map "Unauthorized"
// @Failure 403 {object} fiber.Map "Only the poll creator can close the poll"
// @Failure 404 {object} fiber.Map "Poll not found"
// @Failure 409 {object} fiber.Map "Poll is already closed"
// @Failure 500 {object} fiber.Map "Internal server error"
...
// @Summary Get all polls in a channel
// @Description Returns all polls in a specific channel
// @Tags Polls
// @Produce json
// @Param id path string true "Channel ID"
// @Success 200 {array} models.Poll "List of polls"
// @Failure 400 {object} fiber.Map "Invalid channel ID"
// @Failure 500 {object} fiber.Map "Internal server error"
// @Router /channels/{id}/polls [get]
...
// @Description Deletes a poll. Only the poll creator can delete a poll.
// @Tags Polls
// @Produce json
// @Param id path string true "Poll ID"
// @Success 204 "Poll deleted successfully"
// @Failure 400 {object} fiber.Map "Invalid poll ID"
// @Failure 401 {object} fiber.Map "Unauthorized"
// @Failure 403 {object} fiber.Map "Only the poll creator can delete the poll"
// @Failure 404 {object} fiber.Map "Poll not found"
// @Failure 500 {object} fiber.Map "Internal server error"

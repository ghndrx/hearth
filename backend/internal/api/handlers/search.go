...
// @Description Searches for messages across channels with various filters like server, channel, author, time range, and content flags
// @Tags Search
// @Accept json
// @Produce json
// @Param q query string true "Search query string"
// @Param guild_id query string false "Filter by server ID"
...
// @Param mentions query []string false "Filter by mentioned user IDs"
// @Param limit query int false "Number of results to return (default 25, max 100)"
// @Param offset query int false "Offset for pagination"
// @Success 200 {object} SearchMessagesResponse "Search results with messages"
// @Failure 400 {object} fiber.Map "Invalid query parameters"
// @Failure 401 {object} fiber.Map "Unauthorized"
// @Failure 403 {object} fiber.Map "Not a server member or no permission"
...
func (h *SearchHandler) SearchMessages(c *fiber.Ctx) error {
	...
	for _, msg := range result.Messages {
		...
		// ServerID is now derived from channel, not message
...
// @Description Searches for users by username or display name, optionally filtered by server membership
// @Tags Search
// @Accept json
// @Produce json
// @Param q query string true "Search query string"
// @Param guild_id query string false "Filter by server ID"
// @Param limit query int false "Number of results to return (default 25, max 100)"
// @Success 200 {object} SearchUsersResponse "Search results with users"
// @Failure 400 {object} fiber.Map "Invalid query parameters"
// @Failure 401 {object} fiber.Map "Unauthorized"
...
// @Description Searches for channels by name, optionally filtered by server
// @Tags Search
// @Accept json
// @Produce json
// @Param q query string true "Search query string"
// @Param guild_id query string false "Filter by server ID"
// @Param limit query int false "Number of results to return (default 25, max 100)"
// @Success 200 {object} SearchChannelsResponse "Search results with channels"
// @Failure 400 {object} fiber.Map "Invalid query parameters"
// @Failure 401 {object} fiber.Map "Unauthorized"
// @Failure 403 {object} fiber.Map "Not a server member"
// @Failure 500 {object} fiber.Map "Search failed"
...
// @Description Performs a combined search across messages, users, and channels
// @Tags Search
// @Accept json
// @Produce json
// @Param q query string true "Search query string"
// @Param guild_id query string false "Filter by server ID"
// @Success 200 {object} fiber.Map "Combined search results with messages, users, and channels"
// @Failure 400 {object} fiber.Map "Invalid query parameters"
// @Failure 401 {object} fiber.Map "Unauthorized"
// @Failure 500 {object} fiber.Map "Search failed"
// @Router /search [get]
...
// @Description Returns search suggestions for type-ahead/autocomplete functionality
// @Tags Search
// @Accept json
// @Produce json
// @Param q query string false "Partial search query"
// @Param guild_id query string false "Filter by server ID"
// @Param limit query int false "Number of suggestions to return (default 5, max 20)"
// @Success 200 {object} services.SearchSuggestionsResponse "Search suggestions"
// @Failure 400 {object} fiber.Map "Invalid query parameters"
// @Failure 401 {object} fiber.Map "Unauthorized"
// @Failure 500 {object} fiber.Map "Failed to get suggestions"

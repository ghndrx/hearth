...
func SetupRoutes(app *fiber.App, h *handlers.Handlers, m *middleware.Middleware) {
	...
	if h.Soundboard != nil {
		...
		servers.Get("/:id/soundboard/:soundId", h.Soundboard.GetSound)
		servers.Patch("/:id/soundboard/:soundId", h.Soundboard.ModifySound)
		servers.Delete("/:id/soundboard/:soundId", h.Soundboard.DeleteSound)
	}
	...
	if h.Discovery != nil {
		...
		discovery.Get("/search", h.Discovery.SearchServers)

...
const (
	...
	WSEventStageCreated           = "STAGE_CREATED"
	WSEventStageUpdated           = "STAGE_UPDATED"
	WSEventStageEnded             = "STAGE_ENDED"
	WSEventStagePaused            = "STAGE_PAUSED"
	WSEventStageResumed           = "STAGE_RESUMED"
	WSEventStageSpeakerAdded      = "STAGE_SPEAKER_ADD"
	WSEventStageSpeakerRemove     = "STAGE_SPEAKER_REMOVE"
	WSEventStageModeratorAdded    = "STAGE_MODERATOR_ADD"
	WSEventStageModeratorRemoved  = "STAGE_MODERATOR_REMOVE"
	WSEventStageRequestToSpeak    = "STAGE_REQUEST_TO_SPEAK"
	WSEventStageAudienceEnter     = "STAGE_AUDIENCE_ENTER"
	WSEventStageAudienceLeave     = "STAGE_AUDIENCE_LEAVE"
	WSEventStageParticipantRemove = "STAGE_PARTICIPANT_REMOVE"
)
